...
/**
 * Attempt to extract latitude/longitude information from a location record returned by Supabase.
 * Mirrors the approach used in the Network page while keeping the logic reusable.
 */
