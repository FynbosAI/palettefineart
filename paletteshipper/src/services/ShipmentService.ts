...
export class ShipmentService {
  ...
  static async approveChangeRequest(requestId: string, responseNotes?: string): Promise<{ data: any | null; error: any }> {
  ...
  static async counterChangeRequest(requestId: string, counterAmount: number, notes?: string): Promise<{ data: any | null; error: any }> {
    return this.postApi('/api/counter-change-request', {
      p_change_request_id: requestId,
      p_new_amount: counterAmount,
      p_notes: notes,
    });
  }

  static async rejectChangeRequest(requestId: string, responseNotes?: string): Promise<{ data: any | null; error: any }> {
