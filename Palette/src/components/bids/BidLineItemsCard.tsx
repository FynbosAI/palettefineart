...
const BidLineItemsCard: React.FC<BidLineItemsCardProps> = ({
  ...
  if (isLocked) {
    return (
      <section
        ...
        aria-label="Bid breakdown locked"
      >
        <div
          style={{
            width: '44px',
        ...
        <div>
          ...
          <p style={{ margin: 0, fontSize: '14px', lineHeight: 1.5 }}>
            {lockedReason || 'The shipper has chosen not to share individual line items for this bid.'}
          </p>
        </div>
      </section>
    );
  ...
  if (!sortedItems.length) {
    return (
      <section
        ...
        aria-label="Bid breakdown unavailable"
      >
  ...
  return (
    <section
      ...
      aria-label="Detailed bid line items"
    >
      <header
        style={{
          display: 'flex',
